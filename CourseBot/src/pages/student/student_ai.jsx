...
//       setMessage("Failed to load chat: " + error.message);
//     }
//   };

//   // Handle content selection via edit button
...
//   // Handle submit selected content
//   const handleSubmitSelected = async () => {
//     if (selectedContent.length === 0) {
//       setMessage("Please select at least one content item.");
//       return;
//     }
...
//       if (!response.ok) {
//         const errorData = await response.json();
//         throw new Error(errorData.message || "Failed to submit content");
//       }
...
//       setMessage("Failed to submit content: " + error.message);
//     }
//   };
...
//       setMessage("Failed to get answer: " + error.message);
//       setChatMessages((prevMessages) =>
//         prevMessages.map((msg, index) =>
//           index === prevMessages.length - 1
//             ? {
...
//                 className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-3 px-4 rounded-xl flex items-center justify-center gap-2 text-sm font-semibold transition-all transform hover:scale-105 shadow-lg disabled:opacity-50"
...
//       {/* Main Content */}
//       <main
//         className={`flex-1 transition-all duration-300 ${isSidebarOpen ? "ml-64 sm:ml-80" : "ml-0 sm:ml-80"} ${isChatExpanded ? "p-0" : "p-4 sm:p-10"}`}
//       >
//         <button
...
//                   Explore your course resources with AI assistance
//                 </p>
//               </div>
...
//             {message && (
//               <div
//                 className={`p-3 rounded-xl mb-6 shadow-sm text-sm animate-fade ${message.includes("success")
...
//                       } cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105 hover:-translate-y-1 ${selectedContent.includes(item.content_id) ? "border-2 border-blue-500" : ""
//                       }`}
//                     onClick={() => handleCardClick(item)}
//                   >
...
//                         onClick={(e) => {
//                           e.stopPropagation();
//                           handleContentSelection(item.content_id);
//                         }}
//                       >
//                         <FaEdit size={12} />
//                       </button>
...
//                       <div className="flex items-start gap-4">
//                         <div
//                           className={`p-3 rounded-xl ${getTypeColor(item.content_type).bg} ${getTypeColor(item.content_type).text} shadow-sm`}
//                         >
...
//         >
//           <div
//             className={`${isChatExpanded ? "h-full flex flex-col" : "glass-effect rounded-3xl border shadow-xl"} ${!isChatExpanded ? "p-8" : ""}`}
//           >
//             <div
...
//             <div
//               className={`${isChatExpanded ? "flex-1 overflow-y-auto px-6" : "max-h-96 overflow-y-auto"} custom-scroll ${chatMessages.length > 0 ? "mb-6" : ""}`}
//             >
