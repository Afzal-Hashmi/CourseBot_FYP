...
const StudentProfile = () => {
  ...
  useEffect(() => {
    try {
      ...
      const isGoogleLoginRaw = Cookies.get("isGoogleLogin");
      ...
      setIsGoogleLogin(isGoogleLoginRaw === "true");
    } catch (error) {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-0 lg:ml-72 p-4 sm:p-6 lg:p-8 transition-all duration-300">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm mb-6 sm:mb-8">
            ...
            >
              ...
              {isGoogleLogin ? (<button
                type="submit"
                disabled={isGoogleLogin}
                className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl transition-all duration-200 transform hover:scale-105 text-sm sm:text-base"
              >
                Profile is managed by Google, no changes allowed
              </button>)
                : (
                  <button
                    type="submit"
          ...
          {!isGoogleLogin && (<div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-6 flex items-center gap-2">
